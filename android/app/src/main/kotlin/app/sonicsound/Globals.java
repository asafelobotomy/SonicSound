...
public class Globals {
    ...
    private Globals() {
        ...
        mediaSession = new MediaSessionCompat(App.getContext(), "SonicSound");
        mediaSession.setCallback(new SonicSoundSessionCallbacks());
    ...
    public static void NotifyObservers(String action, String value) {
        if (Objects.equals(action, "EX")) {
            Log.e("SonicSound Exception", value != null ? value : "Unknown error");
        }
        for (IBroadcastObserver observer : getInstance().observers) {
            try {
                ...
                Log.e("SonicSound Globals", message);
            }
        }
    }
